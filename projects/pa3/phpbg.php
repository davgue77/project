<?php
        ...
        //Dawn
        elseif(($mytime >= 1) && ($mytime <= 5)){
            $img = 'dawn.jpg';
        }
        //Morning
        elseif(($mytime > 5) && ($mytime <= 11)){
            $img = 'morning.jpg';
        }
        //Noon
        elseif($mytime == 12) {
        ...
        //Afternoon
        elseif(($mytime > 12) && ($mytime <= 17)) {
            $img = 'afternoon.jpg';
        }
        //Evening
        elseif(($mytime > 17) && ($mytime <= 21)) {
            $img = 'evening.jpg';
        }
        //Night
        elseif(($mytime > 21) && ($mytime <= 23)) {
            $img = 'night.jpg';
        }
?>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="section-title text-center pb-30">
            <h2>PHP Automatic Background Image</h2>

...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            ...
            <li><a class="getstarted scrollto" href="signup-user.php">Sign-Up</a></li>
            </ul>
          ...
          <div class="col-lg-4 mb-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
                <form action="login-user.php" method="POST" autocomplete="">
                        ...
                        <div class="form-group">
                            <input class="btn btn-primary" style="background-color:#5777ba; border-color:#5777ba" type="submit" name="login" value="Login">
                        </div>
